...
router.post(
  ...
  adminMiddleware,
  validatorCreatePost,
  createPost({ Post, buildResponse, handleHttpError, matchedData }),
);
...
router.patch(
  ...
  adminMiddleware,
  validatorUpdatePost,
  updatePost({ Post, buildResponse, handleHttpError, matchedData }),
);
...
router.delete(
  '/:id',
  adminMiddleware,
  deletePost({ Post, buildResponse, handleHttpError }),
);
...
router.patch(
  '/:id/restore',
  adminMiddleware,
  restorePost({ Post, buildResponse, handleHttpError }),
);
