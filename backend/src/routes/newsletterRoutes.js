...
router.post(
  '/subscribe',
  subscribe({ Newsletter, buildResponse, handleHttpError }),
);
...
router.get(
  '/unsubscribe',
  unsubscribe({ Newsletter, buildResponse, handleHttpError }),
);
...
router.post(
  '/send',
  adminMiddleware,
  sendNewsletter({ Newsletter, buildResponse, handleHttpError }),
);
...
router.get(
  '/count',
  adminMiddleware,
  getSubscriberCount({ Newsletter, buildResponse, handleHttpError }),
);
