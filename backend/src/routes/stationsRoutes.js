...
import {
  ...
  getCodeStation,
  getStationsGeoJson,
  getStationsStatistics,
  getStationsStatusClosed,
  getStationsStatusOpen,
} from '../controllers/seimiscStationsControllers.js';
...
router.get(
  '/status/open',
  getStationsStatusOpen({ buildResponse, handleHttpError }),
);
...
router.get(
  '/status/closed',
  getStationsStatusClosed({ buildResponse, handleHttpError }),
);
...
router.get(
  '/statistics',
  getStationsStatistics({ buildResponse, handleHttpError }),
);
