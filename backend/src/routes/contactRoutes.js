...
router.get(
  '/',
  adminMiddleware,
  listAllContacts({ Contact, buildResponse, handleHttpError }),
);
...
router.get(
  '/:id',
  adminMiddleware,
  listOneContact({ Contact, buildResponse, handleHttpError }),
);
...
router.delete(
  '/:id',
  adminMiddleware,
  deleteContact({ Contact, buildResponse, handleHttpError }),
);
