...
import {
  ...
  updateTestimonial,
  deleteTestimonial,
} from '../controllers/testimonialsControlles.js';
...
router.post(
  ...
  createTestimonial({ Testimonial, buildResponse, handleHttpError }),
);

// NOTE: Defining a [GET] route to list all reviews
router.get(
  '/',
  listAllTestimonials({ Testimonial, buildResponse, handleHttpError }),
);
...
router.get(
  '/:id',
  adminMiddleware,
  listOneTestimonial({ Testimonial, buildResponse, handleHttpError }),
);
...
router.patch(
  '/:id',
  authMiddleware,
  updateTestimonial({ Testimonial, buildResponse, handleHttpError }),
);
...
router.delete(
  '/:id',
  authMiddleware,
  deleteTestimonial({ Testimonial, buildResponse, handleHttpError }),
);
