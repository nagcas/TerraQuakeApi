...
router.get(
  '/',
  adminMiddleware,
  listAllUsers({ User, buildResponse, handleHttpError }),
);
...
router.post(
  '/:id/role',
  validatorUpdateRoleById,
  updateRoleById({ User, buildResponse, handleHttpError }),
);
...
router.get(
  '/me',
  authenticateUser,
  getCurrentUserData({ User, buildResponse, handleHttpError }),
);
...
router.patch(
  ...
  authenticateUser,
  validatorUpdateCurrentUserData,
  updateCurrentUserData({ User, buildResponse, handleHttpError, matchedData }),
);
...
router.patch(
  ...
  validatorUpdateCurrentUserData,
  validatorUpdateDeleted,
  updateUserData({ User, buildResponse, handleHttpError, matchedData }),
);
...
router.delete(
  '/me',
  authenticateUser,
  deleteCurrentUser({ User, buildResponse, handleHttpError, invalidateToken }),
);
...
router.delete(
  '/:id',
  adminMiddleware,
  deleteUser({ User, buildResponse, handleHttpError, invalidateToken }),
);
