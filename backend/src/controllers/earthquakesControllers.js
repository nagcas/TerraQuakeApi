...
export const getEarthquakesByRecent = ({ buildResponse, handleHttpError }) => {
  return async (req, res) => {
    try {
      ...
      res.status(200).json({
        ...buildResponse(req, message, result.items),
      ...
      console.error(
        'Error retrieving recent earthquakes controller:',
        error.message,
      );
...
export const getEarthquakesByToday = ({ buildResponse, handleHttpError }) => {
  return async (req, res) => {
    try {
      ...
      // Log error to the server console
      console.error(
        'Error retrieving earthquakes today controller:',
        error.message,
      );
      // Handle unexpected errors gracefully
      handleHttpError(
 ...
 * @param {import('express').Response} res
 */
export const getEarthquakesByLastWeek = ({
  buildResponse,
  handleHttpError,
}) => {
  return async (req, res) => {
    try {
      ...
      // Log error to the server console
      console.error(
        'Error retrieving earthquakes last week controller:',
        error.message,
      );
      // Handle unexpected errors gracefully
      handleHttpError(
  ...
  return async (req, res) => {
    try {
      ...
      if (isNaN(depthValue) || depthValue <= 0) {
        return handleHttpError(
          res,
          'The depth parameter must be a positive number greater than 0',
          400,
        );
      }
      ...
      // Log error to the server console
      console.error(
        'Error retrieving earthquakes depth controller',
        error.message,
      );
      // Handle unexpected errors gracefully
      handleHttpError(
 ...
 * @param {import('express').Response} res
 */
export const getEarthquakesByDateRange = ({
  buildResponse,
  handleHttpError,
}) => {
  return async (req, res) => {
    try {
      ...
      if (minmag) {
        ...
        if (isNaN(magValue) || magValue < 0) {
          return handleHttpError(
            res,
            '"minmag" must be a positive number.',
            400,
          );
        }
      ...
      // Log error to the server console
      console.error(
        'Error retrieving earthquakes by date range:',
        error.message,
      );
      // Handle unexpected errors gracefully
      handleHttpError(
 ...
 * @param {import('express').Response} res
 */
export const getEarthquakesByMagnitude = ({
  buildResponse,
  handleHttpError,
}) => {
  return async (req, res) => {
    try {
      ...
      // Log error to the server console
      console.error(
        'Error retrieving earthquakes by magnitude:',
        error.message,
      );
      // Handle unexpected errors gracefully
      handleHttpError(
...
export const getEarthquakesById = ({ buildResponse, handleHttpError }) => {
  return async (req, res) => {
    try {
      ...
      // Log error to the server console
      console.error(
        'Error retrieving earthquakes eventId controller',
        error.message,
      );
      // Handle unexpected errors gracefully
      handleHttpError(
...
export const getEarthquakesLocation = ({ buildResponse, handleHttpError }) => {
  return async (req, res) => {
    try {
      ...
      // Log error to the server console
      console.error(
        'Error retrieving earthquakes location controller',
        error.message,
      );
      // Handle unexpected errors gracefully
      handleHttpError(
