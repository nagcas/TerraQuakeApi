  ...
  apiReference: {
    earthquakes: [
      ...
      },
      {
        ...
        description: 'Fetches earthquakes that occurred today.',
        query: ['page', 'limit'],
      },
      {
        method: 'GET',
        path: '/v1/earthquakes/last-week',
        description: 'Fetches earthquakes from the last 7 days.',
        query: ['page', 'limit'],
      },
      {
        method: 'GET',
        path: '/v1/earthquakes/month',
        description: 'Fetches earthquakes for a specific month and year.',
        query: ['year', 'month', 'page', 'limit'],
      },
      {
        method: 'GET',
        path: '/v1/earthquakes/location',
        description: 'Fetches earthquakes near a latitude/longitude.',
        query: ['latitude', 'longitude', 'radius', 'page', 'limit'],
      },
      {
        method: 'GET',
        path: '/v1/earthquakes/region',
        description: 'Fetches earthquakes in a specific Italian region.',
        query: ['region', 'page', 'limit'],
      },
      {
        method: 'GET',
        path: '/v1/earthquakes/depth',
        description: 'Fetches earthquakes at or below a specific depth.',
        query: ['depth', 'page', 'limit'],
      },
      {
        method: 'GET',
        path: '/v1/earthquakes/range-time',
        description: 'Fetches earthquakes within a date range.',
        query: ['startdate', 'enddate', 'page', 'limit'],
      },
      {
        method: 'GET',
        path: '/v1/earthquakes/magnitude',
        description: 'Fetches earthquakes of a specific magnitude or higher.',
        query: ['mag', 'page', 'limit'],
      },
      {
        method: 'GET',
        path: '/v1/earthquakes/eventId',
        description: 'Fetches details of a specific earthquake by ID.',
        query: ['eventId'],
      },
    ],
