...
export default function ClientFeedback() {
  ...
  return (
    <main className='w-ful h-screen mt-4'>
      <section
        className='max-w-screen relative h-screen container text-white  rounded-lg  py-14'
        ref={testimonialRef}
      >
        <article className={'max-w-screen-md mx-auto text-center space-y-2 '}>
          <TimelineContent
            as='h1'
            className={
              'xl:text-4xl text-3xl  font-medium  bg-gradient-to-r from-[#C137D0] to-[#F035A1] bg-clip-text text-transparent pb-2'
            }
            animationNum={0}
        ...
        <div className='lg:grid lg:grid-cols-3  gap-2 flex flex-col w-full lg:py-10 pt-10 pb-4 lg:px-10 px-4'>
          <div className='md:flex lg:flex-col lg:space-y-2 h-full lg:gap-0 gap-2 '>
            ...
            >
              ...
              <article className='mt-auto'>
                <p>
                  "TerraQuake has transformed how our research team tracks
                  seismic activity. The real-time API has made our monitoring
            ...
            <TimelineContent
              ...
              customVariants={revealVariants}
              timelineRef={testimonialRef}
              className='lg:flex-[3] flex-[4] lg:h-fit  lg:shrink-0 flex flex-col justify-between relative bg-[#172554] text-white overflow-hidden rounded-lg border border-blue-500/30 p-5'
            >
              <article className='mt-auto'>
                <p className='text-gray-300'>
                  "We integrated TerraQuake API into our disaster-response
                  system, and now alerts reach communities in seconds."
                </p>
          ...
          <div className='lg:h-full  md:flex lg:flex-col h-fit lg:space-y-2 lg:gap-0 gap-2'>
            <TimelineContent
              ...
              customVariants={revealVariants}
              timelineRef={testimonialRef}
              className='flex flex-col justify-between relative bg-zinc-900 text-white overflow-hidden rounded-lg border border-gray-800 p-5'
            >
              <article className='mt-auto'>
                ...
                <div className='flex justify-between items-end pt-5'>
                  <div>
                    ...
                    <p className='lg:text-base text-sm text-gray-400'>
                      Data Scientist, QuakeSense Labs
                    </p>
                  </div>
                  <img
                    src='https://avatar.iran.liara.run/public/15'
            ...
            >
              <article className='mt-auto'>
                <p className='2xl:text-base text-sm text-gray-300'>
                  "As a developer, the API docs are some of the cleanest I’ve
                  seen. Integration was seamless."
                </p>
                <div className='flex justify-between items-end pt-5'>
                  <div>
                    <h2 className=' font-semibold lg:text-xl text-lg text-gray-100'>
                    ...
                    <p className='lg:text-base text-sm text-gray-400'>
                      {' '}
                      Full-Stack Engineer, QuakeAlert
                    </p>
                  </div>
                  <img
                    src='https://avatar.iran.liara.run/public/15'
          ...
          <div className='h-full md:flex lg:flex-col lg:space-y-2 lg:gap-0 gap-2'>
            <TimelineContent
              ...
              customVariants={revealVariants}
              timelineRef={testimonialRef}
              className=' lg:flex-[3] flex-[4] flex flex-col justify-between relative bg-[#172554] text-white overflow-hidden rounded-lg border border-blue-500/30 p-5'
            >
              <article className='mt-auto'>
                <p className='text-gray-300'>
                  "With TerraQuake’s advanced filtering, we built a dashboard
                  that tracks only high-magnitude events in our region."
                </p>
                <div className='flex justify-between pt-5'>
                  <div>
                    <h2 className=' font-semibold text-xl text-gray-100'>
              ...
              <article className='mt-auto'>
                ...
                <div className='flex justify-between pt-5'>
                  <div>
                    ...
                    <p className='text-gray-400'>
                      Geophysics Dept, Stanford University
                    </p>
                  </div>
                  <img
                    src='https://avatar.iran.liara.run/public/15'
