      ...
      <section className='relative z-30 w-full min-h-screen px-6 py-20'>
        ...
        <div className='max-w-2xl mx-auto mt-10 bg-gradient-to-br from-white/5 to-violet-950/10 border border-white/10 backdrop-blur-md rounded-2xl p-8 shadow-lg'>
          <p className='text-gray-300 text-lg mb-6'>
            We welcome your feedback, questions, and collaboration proposals!
            Reach out for support, to report issues, or to suggest new features
            for TerraQuake API.
          </p>
          <div className='mb-6'>
            ...
            <a
              ...
              className='text-indigo-400 hover:text-purple-300 underline'
            >
          ...
          <div className='mb-6'>
            ...
            <a
              ...
              className='text-indigo-400 hover:text-purple-300 underline mr-4'
            >
              Twitter/X
            </a>
            <a
          ...
          <div className='mb-6'>
            ...
            <p className='text-gray-300'>
              Your contact information will be used solely for support and will
              not be shared. For details, see our{' '}
              <a
                href='/privacyPolicy'
                className='text-indigo-400 hover:text-purple-300 underline'
              >
          ...
          <div>
            ...
            <p className='text-gray-300'>
              Want to help improve TerraQuake API? Visit our{' '}
              <a
                href='https://github.com/nagcas/TerraQuakeApi'
                target='_blank'
                rel='noopener noreferrer'
