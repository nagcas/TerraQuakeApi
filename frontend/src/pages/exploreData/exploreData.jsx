        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          >
            ...
            <p className="text-xl text-white/70 max-w-7xl mx-auto">
              Welcome to the <strong>TerraQuake API Playground</strong>! Explore and interact with earthquake data in real time.
              Test API queries with different parameters such as magnitude, location, or time range, view raw JSON results, and copy ready-to-use code snippets.
            </p>
          </motion.div>
