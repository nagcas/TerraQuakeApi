  ...
  const listAllPosts = async () => {
    ...
    try {
      ...
      if (!hasLoadedCategories.current || selectedCategory === '') {
        const uniqueCats = [...new Set(payload.posts.flatMap(p => p.categories || []))];
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 text-white/70">
          ...
          >
            ...
            <p className="text-xl text-center text-white/70 max-w-7xl">{t('blog.description')}</p>
                ...
                <button
                  ...
                  className={`px-6 py-2 rounded-full text-sm font-semibold transition-all duration-300 border ${
                    selectedCategory === cat
                      ...
                      : 'bg-white/5 text-gray-400 border-white/10 hover:bg-white/10 hover:border-purple-500/50'
                  }`}
                >
          ...
          {error ? (
            <div className="text-center py-20">
              ...
              <button 
                ...
                className="py-2 px-8 rounded-full bg-white/10 text-white hover:bg-white/20 transition-all"
              >
                {t('blog.retry')}
              </button>
            </div>
                    ...
                    <div className="flex items-center justify-between text-xs text-gray-500 border-t border-gray-800 pt-4">
                      <div className="flex items-center space-x-4">
                        <div className="flex items-center space-x-1">
                          ...
                          <span>{post.author?.name || 'TerraQuake Author'}</span>
                        </div>
                        <div className="flex items-center space-x-1">
            ...
            <div className="text-center py-20">
              <h2 className="text-2xl text-white font-bold">{t('blog.no_posts')}</h2>
