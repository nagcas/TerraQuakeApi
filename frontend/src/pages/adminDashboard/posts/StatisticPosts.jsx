...
export default function StatisticPosts({ postsMonths }) {
  ...
  return (
    <>
      <button
        ...
        title={t('statistics_posts.title')}
      >
        {t('statistics_posts.title_button')}
      </button>
            ...
            >
              ...
              <div className='p-8 max-h-[70vh] overflow-y-auto'>
                <div className='space-y-4'>
                  {Object.entries(postsMonths).map(([month, count]) => {
                    const maxValue = Math.max(...Object.values(postsMonths));
