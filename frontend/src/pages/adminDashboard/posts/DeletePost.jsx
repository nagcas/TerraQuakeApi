...
export default function DeletePost({ posts, setPosts }) {  
    ...
    const handleDelete = async () => {
      try {
        ...
        await Swal.fire({
          title: 'Deleted!',
          text: response.data.message || 'Post has been deleted successfully.',
          icon: 'success',
        ...
        setPosts((prev) =>
          prev.map((u) =>
            u._id === posts._id ? { ...u, deleted: true } : u
          )
        );
              ...
              >
                ...
                <div className='flex flex-col items-center gap-4 mt-20'>
                  <p className='text-2xl text-center p-2 pt-5 text-gray-300'>
                    You are about to deactivate this post. This is a reversible action and the post can be restored at any time.
                  </p>
                  <p className='text-xl text-center p-2 text-gray-300'>
                    Please confirm that you want to proceed with the temporary deactivation of this post.
                  </p>
                </div>
