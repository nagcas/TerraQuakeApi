      ...
      <section className='relative min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-br from-[#0f0c29] via-  [#302b63] to-[#24243e] px-6 py-20 text-white overflow-hidden'>
        ...
        {isLoggedIn ? (
          <motion.div
            ...
            className='grid grid-cols-1 md:grid-cols-2 gap-10 w-full max-w-6xl relative z-10 mt-6'
          >
            ...
            >
              ...
              <button
                ...
                className='mt-6 py-3 px-8 bg-gradient-to-r from-pink-500 to-purple-600 rounded-full font-semibold text-lg shadow-lg hover:scale-105 transition duration-300 cursor-pointer'
              >
                Logout
              </button>
            </motion.div>
              ...
              {activeSection === null && (
                ...
                >
                  <button
                    ...
                    className='w-60 border border-pink-400 hover:bg-gradient-to-r hover:from-pink-500 hover:to-purple-600 transition-all duration-300 text-white font-semibold py-3 px-8 rounded-full cursor-pointer'
                  >
                    Edit Profile
                  </button>
                  ...
                  <button
                    ...
                    className='w-60 border border-purple-400 hover:bg-gradient-to-r hover:from-purple-600 hover:to-pink-500 transition-all duration-300 text-white font-semibold py-3 px-8 rounded-full cursor-pointer'
                  >
                    Delete Profile
                  </button>
                </motion.div>
              ...
              >
                ...
                <div className='text-center mt-10'>
                  ...
                  <button
                    ...
                    className='mt-4 py-3 px-10 bg-gradient-to-r from-pink-500 to-purple-600 rounded-full font-semibold text-lg shadow-lg hover:scale-105 transition duration-300 cursor-pointer'
                  >
                    Generate Token
                  </button>
                </div>
